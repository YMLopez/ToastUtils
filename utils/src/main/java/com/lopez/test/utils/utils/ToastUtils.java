...
//            !msg.equals(text.getText())
            ...
            mHandler.postDelayed(r, millisecond);//延迟ms秒隐藏toast
    ...
    public static void showToast(String msg, int millisecond) {
        mHandler.showMyToast(msg, millisecond);
    }
    ...
    public static void showToast(int resId, int millisecond) {
        mHandler.showMyToast(mHandler.getResourceString(resId), millisecond);
    }
    ...
    public static void showToastLong(int resId) {
        //不能直接填标识符，不然会失效(那些表示0、1)
        mHandler.showMyToast(mHandler.getResourceString(resId), 3500);
    }
